...
import {
  ...
  size,
  useFloating
} from "./chunk-WUA3DR4E.js";
import {
  createCollection,
  createContextScope,
  useDirection
} from "./chunk-PD27IVUQ.js";
import {
  FocusScope,
  RemoveScrollBar,
  __assign,
...
function useSize(element) {
  const [size2, setSize] = React4.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
function RemoveScrollSideCar(props) {
  ...
  var Style = React10.useState(styleSingleton)[0];
  ...
  return React10.createElement(
    React10.Fragment,
    null,
    inert ? React10.createElement(Style, { styles: generateStyle(id) }) : null,
