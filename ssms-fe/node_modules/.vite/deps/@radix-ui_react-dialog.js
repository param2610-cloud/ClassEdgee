...
var RemoveScroll = React6.forwardRef(function(props, parentRef) {
  ...
  return React6.createElement(
    React6.Fragment,
    null,
    enabled && React6.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime4.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React9.Children.map(children, (child) => (0, import_jsx_runtime4.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime4.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlayImpl = React9.forwardRef(
  (props, forwardedRef) => {
...
var DialogContentModal = React9.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
    const contentRef = React9.useRef(null);
...
var DialogContentNonModal = React9.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
    const hasInteractedOutsideRef = React9.useRef(false);
    const hasPointerDownOutsideRef = React9.useRef(false);
    return (0, import_jsx_runtime4.jsx)(
      DialogContentImpl,
      {
        ...props,
...
var DialogContentImpl = React9.forwardRef(
  (props, forwardedRef) => {
...
var DialogClose = React9.forwardRef(
  (props, forwardedRef) => {
